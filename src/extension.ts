...
export function activate(context: vscode.ExtensionContext) {
    let disposable = vscode.commands.registerCommand('happy-spring-tomcat.setup', async () => {
        ...
        // --- Setup .vscode/happy-spring-tomcat/ ---
...
`;
        ...
        const stopTaskDef = {
            "label": "Stop Tomcat",
            "type": "shell",
            "command": "\${workspaceFolder}\\\\.vscode\\\\happy-spring-tomcat\\\\stop-tomcat.bat",
            "presentation": {
                "reveal": "silent",
                "panel": "shared",
                "close": true,
        ...
        const startTaskDef = {
            ...
            "type": "shell",
            "command": "\${workspaceFolder}\\\\.vscode\\\\happy-spring-tomcat\\\\start-tomcat.bat",
            "isBackground": true,
            "problemMatcher": {
                "pattern": { "regexp": "^$" },
                "background": {
    ...
    let selectTomcatHomeDisposable = vscode.commands.registerCommand('happy-spring-tomcat.selectTomcatHome', async () => {
    ...
    let selectDocBaseDisposable = vscode.commands.registerCommand('happy-spring-tomcat.selectDocBase', async () => {
        const workspaceFolders = vscode.workspace.workspaceFolders;
